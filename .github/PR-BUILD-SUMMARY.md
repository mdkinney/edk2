...
| **Other** | PcAtChipsetPkg, PrmPkg, ShellPkg, SourceLevelDebugPkg, StandaloneMmPkg | DEBUG, RELEASE, NO-TARGET | Arch list |
...
|-----------|---------|-------|---|---|
| **VS2026** | ✓ | ✗ | IA32, X64 | Visual Studio 2022 on Windows |
...
| Job | Toolchain | Builds | Architectures | Tests |
|-----|-----------|--------|---|---|
| **build_windows_vs_basic_acceptance_test** | VS2026 | DEBUG, RELEASE, NOOPT | IA32, X64 | Firmware + Unit Tests + Emulator |
...
19. RedfishPkg
20. PcAtChipsetPkg
21. SourceLevelDebugPkg
22. UnitTestFrameworkPkg
23. StandaloneMmPkg
24. EmulatorPkg
...
- **Default Package Lists** (split into 2 batches for parallelization):
  ...
  - Batch 2: IntelFsp2Pkg, IntelFsp2WrapperPkg, UefiCpuPkg, PrmPkg, NetworkPkg, SecurityPkg, ShellPkg, FmpDevicePkg, FatPkg, RedfishPkg, PcAtChipsetPkg, SourceLevelDebugPkg, UnitTestFrameworkPkg, StandaloneMmPkg, EmulatorPkg
...
**Runners & Images**:
- **Linux**: ubuntu-24.04 runner with custom container `ghcr.io/tianocore/containers/ubuntu-24-build:latest`
- **Linux (QEMU Tests)**: Custom container `ghcr.io/tianocore/containers/ubuntu-24-test:latest`
- **Windows**: windows-2025 runner

**Build Tools**:
- Python 3.12
- Toolchains: VS2026, GCC, CLANGPDB, CLANGDWARF, GCCNOLTO, MinGW variants, LLVM 20
...
| **Toolchains** | 9 toolchains (multiple CLANG, GCCNOLTO variants, LLVM 20) | 2 toolchains (VS2026, GCC) |
