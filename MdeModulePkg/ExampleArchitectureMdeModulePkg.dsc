...
[Defines]
  ...
  SUPPORTED_ARCHITECTURES        = IA32|X64|EBC|ARM|AARCH64|RISCV64|MYCPUARCH
...
[Defines]
  DEFINE VS2019_BIN_MYCPUARCH = C:\Program Files (x86)\Microsoft Visual Studio\2019\BuildTools\VC\Tools\MSVC\14.27.29110\bin\Hostx86\x64

[BuildOptions]
*_VS2019_MYCPUARCH_CC_PATH       = $(VS2019_BIN_MYCPUARCH)\cl.exe
*_VS2019_MYCPUARCH_VFRPP_PATH    = $(VS2019_BIN_MYCPUARCH)\cl.exe
*_VS2019_MYCPUARCH_ASLCC_PATH    = $(VS2019_BIN_MYCPUARCH)\cl.exe
*_VS2019_MYCPUARCH_ASLPP_PATH    = $(VS2019_BIN_MYCPUARCH)\cl.exe
*_VS2019_MYCPUARCH_SLINK_PATH    = $(VS2019_BIN_MYCPUARCH)\lib.exe
*_VS2019_MYCPUARCH_DLINK_PATH    = $(VS2019_BIN_MYCPUARCH)\link.exe
*_VS2019_MYCPUARCH_ASLDLINK_PATH = $(VS2019_BIN_MYCPUARCH)\link.exe
*_VS2019_MYCPUARCH_APP_PATH      = $(VS2019_BIN_MYCPUARCH)\cl.exe
*_VS2019_MYCPUARCH_PP_PATH       = $(VS2019_BIN_MYCPUARCH)\cl.exe
*_VS2019_MYCPUARCH_ASM_PATH      = $(VS2019_BIN_MYCPUARCH)\ml.exe

  DEBUG_VS2019_MYCPUARCH_CC_FLAGS     = /nologo /c /WX /GS- /W4 /Gs32768 /D UNICODE /O1b2s /GL /Gy /FIAutoGen.h /EHs-c- /GR- /GF /Z7 /Gw
RELEASE_VS2019_MYCPUARCH_CC_FLAGS     = /nologo /c /WX /GS- /W4 /Gs32768 /D UNICODE /O1b2s /GL /Gy /FIAutoGen.h /EHs-c- /GR- /GF /Gw
NOOPT_VS2019_MYCPUARCH_CC_FLAGS       = /nologo /c /WX /GS- /W4 /Gs32768 /D UNICODE /Gy /FIAutoGen.h /EHs-c- /GR- /GF /Z7 /Od

  DEBUG_VS2019_MYCPUARCH_ASM_FLAGS    = /nologo /c /WX /W3 /Cx /Zd /Zi
RELEASE_VS2019_MYCPUARCH_ASM_FLAGS    = /nologo /c /WX /W3 /Cx /Zd
NOOPT_VS2019_MYCPUARCH_ASM_FLAGS      = /nologo /c /WX /W3 /Cx /Zd /Zi

  DEBUG_VS2019_MYCPUARCH_NASM_FLAGS   = -Ox -f win64 -g
RELEASE_VS2019_MYCPUARCH_NASM_FLAGS   = -Ox -f win64
NOOPT_VS2019_MYCPUARCH_NASM_FLAGS     = -O0 -f win64 -g

  DEBUG_VS2019_MYCPUARCH_DLINK_FLAGS  = /NOLOGO /NODEFAULTLIB /IGNORE:4001 /IGNORE:4281 /OPT:REF /OPT:ICF=10 /MAP /ALIGN:32 /SECTION:.xdata,D /SECTION:.pdata,D /Machine:X64 /LTCG /DLL /ENTRY:$(IMAGE_ENTRY_POINT) /SUBSYSTEM:EFI_BOOT_SERVICE_DRIVER /SAFESEH:NO /BASE:0 /DRIVER /DEBUG
RELEASE_VS2019_MYCPUARCH_DLINK_FLAGS  = /NOLOGO /NODEFAULTLIB /IGNORE:4001 /IGNORE:4281 /IGNORE:4254 /OPT:REF /OPT:ICF=10 /MAP /ALIGN:32 /SECTION:.xdata,D /SECTION:.pdata,D /Machine:X64 /LTCG /DLL /ENTRY:$(IMAGE_ENTRY_POINT) /SUBSYSTEM:EFI_BOOT_SERVICE_DRIVER /SAFESEH:NO /BASE:0 /DRIVER /MERGE:.rdata=.data
NOOPT_VS2019_MYCPUARCH_DLINK_FLAGS    = /NOLOGO /NODEFAULTLIB /IGNORE:4001 /IGNORE:4281 /OPT:REF /OPT:ICF=10 /MAP /ALIGN:32 /SECTION:.xdata,D /SECTION:.pdata,D /Machine:X64 /LTCG /DLL /ENTRY:$(IMAGE_ENTRY_POINT) /SUBSYSTEM:EFI_BOOT_SERVICE_DRIVER /SAFESEH:NO /BASE:0 /DRIVER /DEBUG

       *_*_MYCPUARCH_CC_FLAGS         = -DEFI_IMAGE_MACHINE_TYPE_VALUE=0
       *_*_MYCPUARCH_CC_FLAGS         = -DEFI_REMOVABLE_MEDIA_FILE_NAME=L\"\\\\EFI\\\\BOOT\\\\BOOTMYCPUARCH.EFI\"

  DEBUG_VS2019_MYCPUARCH_CPP_FLAGS    = -I$(WORKSPACE)\MdeModulePkg\Include\MyCpuArch
  DEBUG_VS2019_MYCPUARCH_CC_FLAGS     = -I$(WORKSPACE)\MdeModulePkg\Include\MyCpuArch
