...
[Defines]
  ...
  BUILD_TARGETS                  = DEBUG|RELEASE|NOOPT|MYTARGET
...
[Defines]
  DEFINE MYTOOLCHAIN_BIN_MYCPUARCH = C:\Program Files (x86)\Microsoft Visual Studio\2019\BuildTools\VC\Tools\MSVC\14.27.29110\bin\Hostx86\x64
  DEFINE RC_PATH                   = C:\Program Files (x86)\Windows Kits\10\bin\10.0.18362.0\x86\rc.exe
  DEFINE NASM_PREFIX               = C:\nasm\
...
[BuildOptions]
  ...
  *_*_*_NASM_PATH        = $(NASM_PREFIX)nasm
  ...
  *_*_*_*_BUILDRULEORDER = nasm asm Asm ASM S s nasmb asm16
  ...
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_*_FAMILY     = MSFT

  MYTARGET_MYTOOLCHAIN_MYCPUARCH_MAKE_PATH    = $(MYTOOLCHAIN_BIN_MYCPUARCH)\nmake.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_MAKE_FLAGS   = /nologo
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_RC_PATH      = $(RC_PATH)

  MYTARGET_MYTOOLCHAIN_MYCPUARCH_SLINK_FLAGS  = /NOLOGO /LTCG
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_APP_FLAGS    = /nologo /E /TC
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_PP_FLAGS     = /nologo /E /TC /FIAutoGen.h
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_VFRPP_FLAGS  = /nologo /E /TC /DVFRCOMPILE /FI$(MODULE_NAME)StrDefs.h
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_DLINK2_FLAGS = /WHOLEARCHIVE

  MYTARGET_MYTOOLCHAIN_MYCPUARCH_CC_PATH      = $(MYTOOLCHAIN_BIN_MYCPUARCH)\cl.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_VFRPP_PATH   = $(MYTOOLCHAIN_BIN_MYCPUARCH)\cl.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_ASLCC_PATH   = $(MYTOOLCHAIN_BIN_MYCPUARCH)\cl.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_ASLPP_PATH   = $(MYTOOLCHAIN_BIN_MYCPUARCH)\cl.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_SLINK_PATH   = $(MYTOOLCHAIN_BIN_MYCPUARCH)\lib.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_DLINK_PATH   = $(MYTOOLCHAIN_BIN_MYCPUARCH)\link.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_ASLDLINK_PATH= $(MYTOOLCHAIN_BIN_MYCPUARCH)\link.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_APP_PATH     = $(MYTOOLCHAIN_BIN_MYCPUARCH)\cl.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_PP_PATH      = $(MYTOOLCHAIN_BIN_MYCPUARCH)\cl.exe
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_ASM_PATH     = $(MYTOOLCHAIN_BIN_MYCPUARCH)\ml.exe

  MYTARGET_MYTOOLCHAIN_MYCPUARCH_CC_FLAGS     = /nologo /c /WX /GS- /W4 /Gs32768 /D UNICODE /O1b2s /GL /Gy /FIAutoGen.h /EHs-c- /GR- /GF /Z7 /Gw
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_ASM_FLAGS    = /nologo /c /WX /W3 /Cx /Zd /Zi
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_NASM_FLAGS   = -Ox -f win64 -g
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_DLINK_FLAGS  = /NOLOGO /NODEFAULTLIB /IGNORE:4001 /IGNORE:4281 /OPT:REF /OPT:ICF=10 /MAP /ALIGN:32 /SECTION:.xdata,D /SECTION:.pdata,D /Machine:X64 /LTCG /DLL /ENTRY:$(IMAGE_ENTRY_POINT) /SUBSYSTEM:EFI_BOOT_SERVICE_DRIVER /SAFESEH:NO /BASE:0 /DRIVER /DEBUG

  MYTARGET_MYTOOLCHAIN_MYCPUARCH_CC_FLAGS     = -DEFI_IMAGE_MACHINE_TYPE_VALUE=0
  MYTARGET_MYTOOLCHAIN_MYCPUARCH_CC_FLAGS     = -DEFI_REMOVABLE_MEDIA_FILE_NAME=L\"\\\\EFI\\\\BOOT\\\\BOOTMYCPUARCH.EFI\"

  MYTARGET_MYTOOLCHAIN_MYCPUARCH_CC_FLAGS     = -I$(WORKSPACE)\MdeModulePkg\Include\MyCpuArch
